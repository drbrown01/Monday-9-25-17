...
fs.writeFile("best_things_ever.txt", "massage, meditation,hot shower,cheese fondue, hot coffee with cashew milk, kitten falling asleep on my lap", function(err){
  console.log("file updated");
  fs.readFile("best_things_ever.txt", "utf8", function(read, data){
    console.log(data)
  });
});
